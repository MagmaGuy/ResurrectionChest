...
public class DeathChestConstructor implements Listener {
    ...
    public void onSignPlace(SignChangeEvent event) {
        ...
        new ResurrectionChestObject(event.getPlayer().getUniqueId(), attached.getLocation());
        ...
        VisualEffect.loadedLocations.add(attached.getLocation());
        VisualEffect.initializeParticleEffects(attached.getLocation());
